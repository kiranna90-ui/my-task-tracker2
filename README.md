...
В этой версии сообщение об ошибке Supabase выводится прямо на странице. Если появится розовая плашка, скопируйте полный текст после двоеточия — по нему можно понять, неверный ли ключ, URL, таблица или политики доступа.
