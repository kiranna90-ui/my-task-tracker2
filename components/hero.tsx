...
export function Hero() {
  return (
    <header className="relative pt-6">
      ...
      {/* Character lowered closer to the main card, without covering its title */}
      <div className="relative z-10 -mb-36 mt-4 flex justify-center">
        <Image
          ...
          height={425}
          priority
          className="h-auto w-[308px] translate-y-8 select-none drop-shadow-[0_18px_30px_rgba(150,90,180,0.25)] sm:w-[340px]"
        />
      </div>
    </header>
  )
