...
export function Hero() {
  return (
    <header className="relative pt-6">
      ...
      {/* Character sits above the main card and is visually pulled closer without card overlap */}
      <div className="relative z-10 mt-5 flex justify-center">
        <Image
          ...
          height={425}
          priority
          className="h-auto w-[308px] translate-y-12 select-none drop-shadow-[0_18px_30px_rgba(150,90,180,0.25)] sm:w-[340px]"
        />
      </div>
    </header>
  )
